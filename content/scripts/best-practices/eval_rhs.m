function xdot = eval_rhs(t, x, r, p)
     ...
     % unpack the states into useful variable names (optional)
     theta = x(1);
     omega = x(2);

     % unpack the inputs into useful variable names (optional)
     tau = r(1);

     % unpack the parameters into useful variable names (optional)
     m = p(1);
     l = p(2);
     g = p(3);
